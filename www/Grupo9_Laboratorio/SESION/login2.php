...
<body style="background-image: url('../crud/images/veris.png'); background-size: cover; background-position: center; background-repeat: no-repeat;">
	...
	$query = "SELECT Nombre FROM usuarios WHERE Rol IN (2)";
	...
	$html = '
		...
		<form action="validar2.php" method="POST" class="content d-flex justify-content-center align-items-center vh-100">
