        ...
        <?php
            ...
            echo '<div class="header_section">
                    <div class="page-header" style="display:flex;justify-content:space-between;">
                        <h2>CRUD-ADM</h2>
                        <h1 class="navbar-brand">HOLA:<span>ADMINISTRADOR</span></h1>
    ...
    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content text-center">
                                <div class="tab-pane active" id="especialidades" role="tabpanel">
                                    <iframe src="../../Especialidad/index.php" style="width: 95%; height: 890px; border: none;"></iframe>
                                </div>
                                <div class="tab-pane" id="medicamentos" role="tabpanel">
                                    <iframe src="../../Medicamentos/index.php" style="width: 95%; height: 890px; border: none;"></iframe>
                                </div>
                                
                            <div class="tab-pane" id="medicos" role="tabpanel">
                                <iframe src="../../Medicos/index.php" style="width: 95%; height: 890px; border: none;"></iframe>
                            </div>
                            <div class="tab-pane" id="pacientes" role="tabpanel">
                            <iframe src="../../Pacientes/index.php" style="width: 95%; height: 890px; border: none;"></iframe>
                        </div>
                       
                    <div class="tab-pane" id="usuarios" role="tabpanel">
                        <iframe src="../../usuarios/index.php" style="width: 95%; height: 890px; border: none;"></iframe>
                    </div>

                    <div class="tab-pane" id="roles" role="tabpanel">
                        <iframe src="../../roles/index.php" style="width: 95%; height: 890px; border: none;"></iframe>
                    </div>
