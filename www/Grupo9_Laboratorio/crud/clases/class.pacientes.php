...
//************* PARTE II ******************	
	...
	public function get_form($IdPaciente = NULL){
		...
		$html = '
		<form name="consulta" method="POST" action="index.php" enctype="multipart/form-data"  onsubmit="return validarFormulario();">
	...
	public function get_list(){
		...
		<button class="btn btn-info mt-3"><a href="index.html" style="color: white;">HOME</a></button>
			...
			<tr>
				<th colspan="8" class="text-center align-middle">LISTA DE PACIENTES</th>
			</tr>
			<tr>
...
while($row = $res->fetch_assoc()){
    ...
    $html .= '
        <tr>
            ...
            <td><button class="btn btn-success"><a href="index.php?d=' . $d_det_final . '">Detalle</a></button></td>
        </tr>';
}
		$html .= '  
		</table>';
        ...
        if($num==0){
            ...
            echo $this->_message_error($mensaje);
                ...
                <tr>
					...
					<tr align="center">
						<th colspan="2"><button class="btn btn-outline-success"><a href="index.php">Regresar</a></button></th>
					</tr>																						
				</table>
				</div>
				</div>
